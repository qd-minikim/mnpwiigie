// page/common/pages/refreshview/refreshview.js
...
/**
 * <refresh-view id='refreshView' backgroundColor="#e3e3e3" bind:onRefresh="onPullDownRefresh" bind:onPullState="_pullState" />
 ...
 * 
 * json中
 *    "usingComponents":{"refresh-view":"/page/common/pages/refreshview/refresh-view"}

 * 
 *  // 刷新组件
    this.refreshView = this.selectComponent("#refreshView")

    如果是在某个组件下不，在当前组件加z-index:9999;background:#fff;
 * 
 */